...
Use the Supabase `service_role` key for `SUPABASE_SERVICE_ROLE_KEY`. Do not use the anon key or publishable key for this backend variable, because the dashboard API writes and updates private proposal records server-side.
